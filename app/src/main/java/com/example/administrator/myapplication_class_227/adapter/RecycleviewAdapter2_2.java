...
import com.example.administrator.myapplication_class_227.user.User.ResultBean.ViewsBean.SheshoubangBean;
 ...
 */
public class RecycleviewAdapter2_2 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private ArrayList<SheshoubangBean> list;
    private Context context;
    public RecycleviewAdapter2_2(Context context){
